...
/* themes/custom/nice_theme/templates/paragraphs/paragraph--layout-one-column.html.twig */
class __TwigTemplate_37356fc1fe6ef1b5de33cf2435478ace extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_layout_one_col_container", [], "any", false, false, true, 3));
...
";
        ...
        // line 12
        $context["class"] = ("paragraph-type-layout paragraph-type-layout-one-column paragraph-id-" . CoreExtension::getAttribute($this->env, $this->source, ($context["paragraph"] ?? null), "id", [], "method", false, false, true, 12));
        // line 13
        $context["column_layout"] = 1;
        // line 14
        yield "
";
        // line 15
        yield from $this->loadTemplate("@nice_theme/components/layout_column/layout_column.twig", "themes/custom/nice_theme/templates/paragraphs/paragraph--layout-one-column.html.twig", 15)->unwrap()->yield(CoreExtension::merge($context, ["class" =>         // line 16
...
($context["use_container"] ?? null)) ? ("page-container") : (""))]));
    ...
    {
        return "themes/custom/nice_theme/templates/paragraphs/paragraph--layout-one-column.html.twig";
    }
    ...
    {
        return new Source("{# Paragraph template for Section One Column #}
{% set items = [] %}
{% for item in content.field_layout_one_col_container %}
  {% if item['#paragraph'] %}
...
{% set class = 'paragraph-type-layout paragraph-type-layout-one-column paragraph-id-' ~ paragraph.id() %}
{% set column_layout = 1 %}
...
} %} ", "themes/custom/nice_theme/templates/paragraphs/paragraph--layout-one-column.html.twig", "/var/www/html/web/themes/custom/nice_theme/templates/paragraphs/paragraph--layout-one-column.html.twig");
    }
