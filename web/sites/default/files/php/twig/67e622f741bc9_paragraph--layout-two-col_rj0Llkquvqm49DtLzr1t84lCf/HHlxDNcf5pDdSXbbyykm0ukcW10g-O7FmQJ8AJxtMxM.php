...
/* themes/custom/nice_theme/templates/paragraphs/paragraph--layout-two-column.html.twig */
class __TwigTemplate_2389d9bdd6ff0e4378ec220856077c22 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_layout_two_col_container", [], "any", false, false, true, 3));
...
";
        ...
        // line 12
        $context["class"] = ("paragraph-type-layout paragraph-type-layout-two-column paragraph-id-" . CoreExtension::getAttribute($this->env, $this->source, ($context["paragraph"] ?? null), "id", [], "method", false, false, true, 12));
        // line 13
        $context["column_layout"] = 2;
        // line 14
        yield "
";
        // line 15
        yield from $this->loadTemplate("@nice_theme/components/layout_column/layout_column.twig", "themes/custom/nice_theme/templates/paragraphs/paragraph--layout-two-column.html.twig", 15)->unwrap()->yield(CoreExtension::merge($context, ["class" =>         // line 16
...
";
    ...
    {
        return "themes/custom/nice_theme/templates/paragraphs/paragraph--layout-two-column.html.twig";
    }
    ...
    {
        return new Source("{# Paragraph template for Section Two Column #}
{% set items = [] %}
{% for item in content.field_layout_two_col_container %}
  {% if item['#paragraph'] %}
...
{% set class = 'paragraph-type-layout paragraph-type-layout-two-column paragraph-id-' ~ paragraph.id() %}
{% set column_layout = 2 %}
...
", "themes/custom/nice_theme/templates/paragraphs/paragraph--layout-two-column.html.twig", "/var/www/html/web/themes/custom/nice_theme/templates/paragraphs/paragraph--layout-two-column.html.twig");
    }
